...
public class CollectionsDriver {
    ...
    public static void main(String[] args) {
        ...
        Set
            ...
            - adds a stronger contract behaviors of the .equals() and .hashcode() operations
            - have no implicit order

     */
        Set<User> userSet = new HashSet<>();
        User u = new User(1, "coarroyo", "password");
        userSet.add(u);
        ...
        User u2 = new User(1, "coarroyo", "password");
        ...
        userMap.put("coarroyo", u);
        userMap.put(null, null);
        userMap.put("skelsey", new User(42, "skelsey", "manager"));
        userMap.put("coarroyo", new User()); //this will override the previous value associated with "coarroyo"

        //this will also override that previously overridden value
        userMap.put(new String("coarroyo"), new User(123, "noone", "nope"));

        User thisUser = userMap.get("coarroyo");
