...
var addIncreasing = ( function() { // Immediately, this function runs, and only once
    var increasingCounter = 0;
    return function() { increasingCounter += 1; return increasingCounter; }; // This second function is returned
}) ();
