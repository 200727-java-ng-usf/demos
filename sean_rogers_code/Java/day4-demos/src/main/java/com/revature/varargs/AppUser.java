...
/*
    POJO Plain ol' Java Object
        ...
        - Characteristics:
            ...
            + overrides the Objects class's .equals(), .hashcode(), and .toString() methods
 */
...
public class AppUser {
    ...
    public AppUser() {
        super(); //not required, it's implied; but Wezley doesn't like having empty constructors
    ...
    */
    public void addRoles(Role... newRoles) {
        ...
        // Make sure that roles in instantiated
        if (roles == null) {
