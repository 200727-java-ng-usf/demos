...
public class ComparatorDriver {
    ...
    public static void main(String[] args) {
        ...
        //using a lambda expression to create an inline representation of employee
        employees.sort((employee1, employee2) -> {
            ...
            else return employee1.getFirstName().compareTo(employee2.getFirstName());
        });
        ...
        /*
            Rules for Lambda Expressions:
                ...
                1. Can only be used to implement a function interface inline
