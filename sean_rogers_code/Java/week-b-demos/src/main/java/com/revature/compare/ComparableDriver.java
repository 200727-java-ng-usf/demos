...
/*
    Comparable
        ...
        -functional interfaces (one abstract method); can be used with lambdas
        -utility classes such as Arrays and Collections have methods that take in Comparable types
