...
public class MoneyFactory {
     ...
     *
     * For looseley coupled classes, changing something major in one class should not affect the other.
     * Tight coupling would make it difficult to change and maintain your code; since classes are
