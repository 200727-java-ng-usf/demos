...
//    multiple tests (suite) per class

//@Before -2nd(on method level)
//@After - 3rd(on method level)
//@Test - instance method level
//@BeforeClass -1st(static method level)
//@AfterClass -4th(static method level)
...
//@RunWith (class-level)
//@Ignore temporarily ignore(instance method level)
//@Rule (instance field level)
public class JUnitBoilerplate {
