...
public class StringDriver {
    public static void main(String[] args) {
        ...
        /*
            ...
            initialize: created a variable, may or may not have assigned a value
            instantiation: creates an object with a value
        ...
        System.out.println(sb2.equals(sb3)); // similar to the Object class, StringBuilder and StringBuffer do not override the .equals method. So, they compare addresses.

        sb2.append(" How's it going?");
        System.out.println(sb2); //SBDR/SBFR objects are mutable!
