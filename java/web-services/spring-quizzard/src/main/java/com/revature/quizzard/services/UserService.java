...
public class UserService {
    ...
    public AppUser findUserByUsername(String username) {
        ...
        try {
            return userRepo.findAppUserByUsername(username).orElseThrow(ResourceNotFoundException::new);
        } catch (Exception e) {
            throw new QuizzardException(e);
        }
    ...
    public Principal authenticate(Credentials creds) {
        ...
        try {
            ...
            AppUser authUser = userRepo.findAppUserByUsernameAndPassword(creds.getUsername(), creds.getPassword())
