...
public class SpringDriver {
    ...
    public static void main(String[] args) {
        ...
        // try with resource
        try (AnnotationConfigApplicationContext container = new AnnotationConfigApplicationContext(AppConfig.class)) { // xml config will have ClassPathXmlApplicationContext
            // AppConfig can be called whatever as long as you put it here
            // can also take more than one configuration class. Ex: Spring MVC has one configuration, and another part of the project has another configuration.
...
//            System.out.println(footballCoach.getEmail());
            ...
            CodeCoach codeCoach = container.getBean("codeCoach", CodeCoach.class); // return type canNOT be contravariant
