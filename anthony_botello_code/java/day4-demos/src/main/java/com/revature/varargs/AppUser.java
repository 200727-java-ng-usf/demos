...
/*
    POJO = Plain Ol' Java Object
        ...
        - Characteristics:
            ...
            + override the Object class's .equals(), .hashcode(), and .toString() methods
*/
public class AppUser{
    ...
    public AppUser(String username, String password, Role[] roles){
        // use 'this' to access instance-scoped variables that have the same name as method-scoped variables
    ...
    public void addRoles(Role... newRoles){
        ...
        // Loop through the newRoles and add each new role into the roles array starting at the index we obtained earlier
        ...
        /*
            Note that the above for loop is slightly different than a typical one
                ...
                - It is incrementing both variables each time the loop makes an iteration
        */
