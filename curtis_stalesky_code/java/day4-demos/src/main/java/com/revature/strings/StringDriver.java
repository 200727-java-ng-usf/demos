    ...
    public static void main(String[] args) {
        ...
        /*
            The Immutability of String
              ...
              - Is thread-safe
                + Instantiated refers to the creation of an object in memory
                + Initialized refers to the creation of a reference (variable) that may or may not have a value
         */
        ...
        s6 = s6.concat(", world!"); // All String API methids return a NEW STRING
        System.out.println(s6);

        String s7 = "hello, world!";
        System.out.println(s6 == s7);

        String s8 = ("hellow" + ", world");
        ...
        // Where as Integer is an object and thus stored in the Integer Pool
