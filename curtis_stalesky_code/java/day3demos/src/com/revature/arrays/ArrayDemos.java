...
//        System.out.println(index1); // NumberFormatException (because "test" can never be an int)
        ...
        //String[] myStrings = new String[] {"This", "is", "new", "set of", "Strings"};

        System.out.println("String representation:" + myArray);
        System.out.println(myArray.length);

        for(int i = 0; i < myArray.length; i++){
            System.out.println(myArray[i]);
        }
    } // <-- Closing brace for "learningArrays" method
