...
public class DummyTest {
    ...
    @Before //acts as a setup method for each test case
    public void beforeEachTest() {
        System.out.println("This will run once before each test case within the test suite.");
    }

    @After //acts as a tear down method for each test case
...
//jUnit test @before, before each, after, after each, test, before class, after class