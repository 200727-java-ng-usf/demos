...
public class CalculatorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher("answer");//URI it is matchedto
        dispatcher.forward(req, resp); //forwarding maintains the original request and responce objects! redirects do not
