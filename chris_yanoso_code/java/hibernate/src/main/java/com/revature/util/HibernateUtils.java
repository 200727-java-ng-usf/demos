    ...
    public static SessionFactory getSessionFactoryProgrammaticConfig() {
        ...
        try {
            Configuration config = new Configuration()
                    ...
                    .setProperty("hibernate.connection.url", "jdbc:postgresql://java-ng-usf-200727.casmekiat9nm.us-east-1.rds.amazonaws.com:5432/postgres?currentSchema=public")
                    ...
                    .addAnnotatedClass(ProjectTeam.class)
