...
public class Cat extends Animal implements Claws, Alive, WaggingTail {
    ...
    private int numberOfLives; //Animal.numberOfLives is shadowed by this
    private String breed;
    private boolean hasFur;

    // a call to super() is implicit
    public Cat() {
    ...
    @Override
    public void scratch() {
        System.out.println("I scratched you with my " + howLongAreClaws +
                " inch claws.");
    }
    @Override
    public void wag() {
