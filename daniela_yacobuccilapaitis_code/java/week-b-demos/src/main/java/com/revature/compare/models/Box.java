...
public class Box implements Comparable <Box>{
    ...
    public int compareTo (Box otherBox) {
        if (this.volume > otherBox.volume) {
            ...
            return 0;//can compare smth else
        }
        // doesnt require this but its common. it depends on your implementation
        // in this case could use compare bc double implements comparable
    }
}
